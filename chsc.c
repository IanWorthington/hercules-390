...
CHSC_RSP12 *chsc_rsp12 = (CHSC_RSP12 *)(chsc_rsp+1);
    ...
    /* Operation Modes:
     *   Basic: BASIC mode operations   [lparmode = 0]
     *   MIF:   Partitions 1-16         [lparmode = 1; cpuidfmt = 0]
     *   EMIF:  Partitions 0-255        [lparmode = 1; cpuidfmt = 1]
     *
     * FIXME: Setting of the MIF mode should be centralized, with the
     *        value in sysblk, and updated whenever one of the
     *        components is changed.
     */
    enum {om_basic=0, om_mif=1, om_emif=2} operation_mode =
      sysblk.lparmode ?
